...
export default {
  ...
  data(){
    return{
      ...
      datalist:[
        ...
        {sign_name:'数据结构',start_time:'2022-01-24 12:00:00',end_time:'2022-01-24 20:00:00',signed_num:22,sign_num:55,user_id:'谢沅峰'},
      ],
      jtotal:15
    }
  },
  computed:{
    ...mapGetters({
      list: 'attendanceStore/historyList',
      total: 'attendanceStore/historyTotal'
    })
  },
  created() {
    this.query.id = this.$route.params.courseId;
    this.query.page = 1;
    this.$store.dispatch('attendanceStore/getHistoryList', this.query).then(res=>console.log(res));
  },
  methods:{
